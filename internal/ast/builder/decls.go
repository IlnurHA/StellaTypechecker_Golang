...
func (v *ASTBuilder) VisitDeclFun(ctx *parser.DeclFunContext) interface{} {
	...
	return &nodes.FunctionDeclaration{Name: name, Params: parameters, Declarations: localDeclarations, ReturnType: returnType, ThrowTypes: throwTypes, Expr: expr, Repr: getOriginalCode(ctx, v)}
}
...
func (v *ASTBuilder) VisitDeclFunGeneric(ctx *parser.DeclFunGenericContext) interface{} {
	...
	return &nodes.GenericFunctionDeclaration{Name: name, Params: parameters, Declarations: localDeclarations, ReturnType: returnType, ThrowTypes: throwTypes, Expr: expr, Generics: generics, Repr: getOriginalCode(ctx, v)}
}
